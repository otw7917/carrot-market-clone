        ...
        <form className='flex flex-col mt-8'>
          ...
          <div>
            {method === "email" ? (
              <input
                type='email'
                className='w-full px-3 py-2 border border-gray-300 rounded-md rounded shadow-md plachoder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 '
                required
              />
            ) : null}
            {method === "phone" ? (
